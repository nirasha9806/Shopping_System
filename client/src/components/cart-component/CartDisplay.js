            ...
            return(
              ...
              <table id="my-table" class="table table-hover">
                ...
                <tr>
                  ...
                  <td>{Cart.quantity}</td>
                  <td>{Cart.price}</td>
                  <td><button className="btn btn-warning"><i className="fas fa-edit"></i><Link  to={"/updateCart/"+Cart._id}>EDIT</Link></button></td>
                  <td><button className="btn btn-danger" onClick={() => Delete(Cart._id)}><i className="fas fa-trash"></i> REMOVE</button></td>
                </tr>
                )}
